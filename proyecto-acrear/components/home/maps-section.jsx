...
export default function MapSection({ regional, provincias }) {
  ...
  return (
    <motion.section
      className="w-full min-h-[500px] sm:min-h-[600px] md:h-[70vh] lg:h-screen relative overflow-hidden py-10 sm:py-16"
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto sm:px-6 space-y-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-8">
          {/* Mapa interactivo */}
          <motion.div
            className="w-full min-h-[250px] sm:h-full md:h-full pl-2 sm:pl-0 rounded-xl overflow-hidden"
